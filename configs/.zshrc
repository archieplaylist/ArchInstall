...
alias lt='exa -ahT --color=always --group-directories-first' # tree listing
...
# weather
alias wttr='curl https://wttr.in/Surabaya\?1n'
alias wttrv2='curl https://v2.wttr.in/Surabaya\?1n'
